...
function ReplyModal({ onClick, setToEveryone, setToFollow }: Props) {
	return (
		<div
		...
		>
			...
			<div className="mt-4 w-full">
				<div className="flex items-center gap-2 rounded-lg p-3 text-xl hover:bg-offWhite" onClick={setToEveryone}>
					<MdPublic />
					<span className="text-xs">Everyone can reply</span>
				</div>
				<div className=" flex items-center gap-2 rounded-lg p-3 text-xl hover:bg-offWhite" onClick={setToFollow}>
					<MdPeople />
